...
//         message: `Hello ${
//           member.firstName
//         },\n\nYou have been added to ${teamName} under the theme "${selectedTheme}".\n\nYour team access code is: ${teamCode}\n\nKeep it safe!\nPolytechnicien`
//       });
//     })
//   );
...
exports.createTeam = catchAsync(async (req, res, next) => {
  ...
  await Promise.all(
    selectedMembers.map(async member => {
      ...
      <body>
        <div class="header">
          <h2>Team Space Access Code</h2>
        </div>
        <div class="content">
          <p>Hello <span class="highlight">${member.firstName}</span>,</p>
          
          <p>You have been added to <span class="highlight">${teamName}</span> under the theme:</p>
          <p><strong>"${selectedTheme}"</strong></p>
          ...
          <p>Please keep this code secure and don't share it with anyone outside your team.</p>
          
          <div class="footer">
            <p>This is an automated message from Polytechnicien Team Management System</p>
